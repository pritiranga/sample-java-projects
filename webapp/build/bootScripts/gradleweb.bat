...
set JARPATH=%APP_HOME%\lib\gradleweb-1.0.0.jar

@rem Execute gradleweb
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GRADLEWEB_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%GRADLEWEB_EXIT_CONSOLE%" exit 1
exit /b 1
